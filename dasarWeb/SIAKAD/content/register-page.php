...
<body class="bg-white min-vh-100 d-flex flex-column">
    ...
    <header class="header-login bg-primary text-white d-flex align-items-center py-3 shadow-sm">
        ...
        <div class="txt-head">
            <h1 class="txt fs-3 fw-bold m-0">REGISTER SIAKAD</h1>
        </div>
    </header>
        ...
        <div class="col-md-4 d-flex flex-column gap-5 ms-5">
            <div id="register">
                <div class="card border rounded-4 shadow p-4 bg-white"> 
                    <h3 class="mb-3 text-center fs-4">Pendaftaran Akun Baru</h3>
                    <form id="registerForm" method="post">
                        <div class="mb-3">
                            <input type="text" id="username_register" name="USERNAME" placeholder="User Name" class="form-control form-control-lg fs-6">
                        </div>
                        <div class="mb-3">
                            <input type="text" id="nim_register" name="NIM" placeholder="NIM" class="form-control form-control-lg fs-6">
                        </div>
                        <div class="mb-3">
                            <input type="password" id="password_register" name="password" placeholder="Password" class="form-control form-control-lg fs-6">
                        </div>
                        <button type="submit" class="btn btn-primary w-100 btn-lg mb-2 fs-6">DAFTAR</button> 
                        <button type="button" id="close_register" class="btn btn-secondary w-100 btn-lg fs-6">Batal</button> 
                    </form>
                    <p id="errorMsgRegister" class="text-danger mb-3 text-center small"></p>
